...
data{
  ...
  real sigma_r; // fixed rate of waning antibodies (0)
  real sigma_m; // fixed rate of waning maternally acquired antibodies
  ...
  //vector[B] age1_fine; // fine resolution ages for seroprevalence
  //vector[B] age2_fine; // fine resolution ages for seroprevalence
